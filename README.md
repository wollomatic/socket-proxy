...
| `-proxysocketendpointallowgroup` | `SP_PROXYSOCKETENDPOINTALLOWGROUP` | (not set/false)        | If set, also group access to the proxied unix socket is allowed (only useful with `-proxysocketendpoint`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
